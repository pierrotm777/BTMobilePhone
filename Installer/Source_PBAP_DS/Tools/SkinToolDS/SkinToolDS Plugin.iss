...
#define iCarDSExtPluginFriendlyName "for iCarDS"
#define iCarDSExtPluginVersion "V1.0.0"
#define iCarDSExtPluginPublisher "P. Montet"
#define iCarDSExtURL "http://pccar.ru/showthread.php?t=14353"

[Setup]
; NOTE: The value of AppId uniquely identifies this application.
; Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{83F36915-BA28-41B2-991C-0FC2AD912530}
AppName=SkinToolDS Plugin for {#iCarDSExtPluginFriendlyName}
AppVerName=SkinToolDS Plugin for {#iCarDSExtPluginFriendlyName} {#iCarDSExtPluginVersion}
...
OutputBaseFilename=SkinToolDS Plugin {#iCarDSExtPluginFriendlyName} {#iCarDSExtPluginVersion} Setup
SourceDir=Bin
Compression=lzma
...
Source: "PJLControls.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "RegAsm.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "RunMe1st.cmd"; DestDir: "{app}"; Flags: ignoreversion
Source: "unregister.cmd"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{code:DataPath}\Skins\Chameleon\ExecTBL.ini"; Type: files 
Name: "{code:DataPath}\Skins\Chameleon\setting.ini"; Type: files 
Name: "{code:DataPath}\Skins\Chameleon\skin.ini"; Type: files
...
begin
  Result := true;
  fileName := ExpandConstant('{code:DataPath}\Skins\Chameleon\ExecTBL.ini.bakBySkinToolDS');
  RenameFile(fileName, ExpandConstant('{code:DataPath}\Skins\Chameleon\ExecTBL.ini'));
  fileName := ExpandConstant('{code:DataPath}\Skins\Chameleon\setting.ini.bakBySkinToolDS');
  RenameFile(fileName, ExpandConstant('{code:DataPath}\Skins\Chameleon\setting.ini'));
  fileName := ExpandConstant('{code:DataPath}\Skins\Chameleon\skin.ini.bakBySkinToolDS');
