...
#Region "PBAP"
    ...
    Public Sub PhoneBookMerge(ByVal PhoneBookList_A As String, ByVal PhoneBookList_B As String)
        ...
        Dim allLines_B As String() = IO.File.ReadAllLines(MainPath & "PhoneBook\MobilePhone_" & PhoneBookList_B & ".txt")
        PhoneBookArray_B.Add("0")
        For Each line As String In allLines_B
            If line <> "0" Then
                line = line.Replace("||", ",")
                spLine_B = line.Split(",")
                PhoneBookArray_B.Add(spLine_B(1) & "," & spLine_B(0))
            Else
                Continue For
            End If
        Next
        ...
        For Each TextLine_A As String In PhoneBookArray_A
            ...
            For Each TextLine_B As String In PhoneBookArray_B
                If TextLine_A = TextLine_B Then
                    TextLine_Match = 1
                End If
            Next
            If TextLine_Match = 0 Then
                PhoneBookArray_B.Add(TextLine_A)
            End If
        Next
        ...
        For Each line As String In PhoneBookArray_B
            If line <> "0" Then
                spLine_B = line.Split(",")
                If spLine_B(0) <> "" Then
                    PhoneBookArray_B2.Add(spLine_B(1) & "||" & spLine_B(0))
                End If
            Else
                Continue For
            End If
