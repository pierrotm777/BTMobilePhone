...
Module modVCard
    ...
    Public Function VCard_CleanUnicode(ByVal inpStr As String) As String
    ...
    Private Sub VCard_SeparateAddressParts(ByVal inpAddress As String, ByRef retPObox As String, ByRef retExtAddr As String, ByRef retStreetAddr As String, ByRef retLocalityCity As String, ByRef retRegionState As String, ByRef retPostalCode As String, ByRef retCountry As String, ByRef retFormattedAddress As String)
        ...
        'this subroutine takes the full address,
    ...
    Private Sub VCard_SeparateNameParts(ByVal inpFullName As String, ByRef retLastName As String, ByRef retFirstName As String, retAdditionalName As String, ByRef retNamePrefix As String, ByRef retNameSuffix As String)
        ...
        For i = 0 To nameWords.Length - 1
            Select Case UCase(nameWords(i))
                Case "MR", "MR.", "MS", "MS.", "MRS", "MRS.", "DR", "DR.", "MME", "MME.", "MLLE", "MLLE." 'duke, earl, lord, sir, etc.
    ...
    Public Function VCard_WriteContactInfo_V3(ByVal vCardFileName As String, ByVal inpCardFullName As String,
                                              ByRef inpPhoneNumbers() As String, ByRef inpPhoneLabels() As String, ByVal inpPhoneCount As Integer,
                                              ByRef inpAddresses() As String, ByRef inpAdrsLabels() As String, ByVal inpAdrsCount As Integer,
                                              Optional ByVal inpImage As Bitmap = Nothing, Optional ByVal inpCardEMailAddress As String = "",
                                              Optional ByVal inpOrganization As String = "", Optional ByVal inpNotes As String = "",
                                               Optional ByVal inpBirthDay As String = "") As Boolean
        ...
        'can do birthday
        If inpBirthDay <> "" Then
            lineStr = "BDAY:" & inpBirthDay & vbCrLf
            lineBytes = System.Text.Encoding.UTF8.GetBytes(lineStr)
            FileAPI_PutBytes(hFile, -1, lineBytes.Length, lineBytes)
    ...
    Public Sub VCard_GetContactInfo(ByVal vCardFileName As String, ByVal vCardOffset As Long, ByRef retCardName As String, ByRef retCardEmail As String, ByRef retPhoneNumbers() As String, ByRef retPhoneLabels() As String, ByRef retPhoneCount As Integer, ByRef retImage As Bitmap, ByRef retLastCallDateTime As String, ByRef retlastCallType As String, ByRef retAddresses() As String, ByRef retAddressLabels() As String, ByRef retAddressCount As Integer, ByRef retBirthDay As String, ByRef retGeoPosition As String, ByRef retNote As String, ByRef retOrganization As String)
        ...
        Dim retAdditionalName As String = ""
        ...
        Do
            ...
            Select Case tempLineType
                ...
                Case "FN"
                    ...
                    'VCard_SeparateNameParts(retCardName, retLastName, retFirstName, retAdditionalName, retNamePrefix, retNameSuffix)
                    'retCardName = retNamePrefix & "**" & retFirstName & "**" & retAdditionalName & "**" & retLastName & "**" & retNameSuffix
                ...
                Case "ADR" '
                    ...
                    Dim retPObox As String = "", retExtAddr As String = "", retStreetAddr As String = "", retLocalityCity As String = "", retRegionState As String = "", retPostalCode As String = "", retCountry As String = ""
                    'VCard_SeparateAddressParts(tempValue, "", "", "", "", "", "", "", tempFormattedAddress)
                    VCard_SeparateAddressParts(tempValue, retPObox, retExtAddr, retStreetAddr, retLocalityCity, retRegionState, retPostalCode, retCountry, tempFormattedAddress)

                    ReDim Preserve retAddresses(0 To retAddressCount)
                    ReDim Preserve retAddressLabels(0 To retAddressCount)

                    If tempFormattedAddress <> "" Then
                        'ToLog("ADR:" & retPObox & "|" & retExtAddr & "|" & retStreetAddr & "|" & retLocalityCity & "|" & retRegionState & "|" & retPostalCode & "|" & retCountry)
                        Dim ttmmpp As String = retPObox & "|" & retExtAddr & "|" & retStreetAddr & "|" & retLocalityCity & "|" & retRegionState & "|" & retPostalCode & "|" & retCountry
                        retAddresses(retAddressCount) = VCard_CleanUnicode(ttmmpp) 'tempFormattedAddress
                ...
                Case "X-IRMC-CALL-DATETIME"
                    retLastCallDateTime = tempSubType.Trim & "," & tempValue.Trim 'VCard_ConvertStringToDateTime(tempValue) 
