...
Module modBlueSoleil_AVRCP
    ...
    Private Sub BlueSoleil_AVRCP_Callback_PassThruCmd_Func(ByVal op_id As Byte, ByVal state_flag As Byte)
        ...
        ToLog("BlueSoleil_AVRCP_Callback_PassThruCmd_Func")
        ...
        Select Case op_id
            Case BTSDK_AVRCP_OPID_AVC_PANEL_PLAY
                ToLog("BlueSoleil_AVRCP_Callback_PassThruCmd BTSDK_AVRCP_OPID_AVC_PANEL_PLAY")
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseBattStatusChangedNotif(ByVal hdl As UInt32, ByVal ptrEvtData As IntPtr)
        ...
        ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - BatteryChanged - rspCode = " & rspCode & "   statusID = " & statusID)
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseGetItemAttribsResponse(ByVal hdl As UInt32, ByVal ptrEvtData As IntPtr)
        ...
        'ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - Len = " & strucSize)
                    ...
                    If entryAttrLen + currByteIdx <= evtData.Length Then
                        ...
                        Select Case entryAttrID
                            Case BTSDK_AVRCP_MA_NAMEOF_ARTIST
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - Artist = " & entryAttrVal)

                            Case BTSDK_AVRCP_MA_NAMEOF_ALBUM
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - Album = " & entryAttrVal)

                            Case BTSDK_AVRCP_MA_TITLEOF_MEDIA
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - Title = " & entryAttrVal)

                            Case BTSDK_AVRCP_MA_PLAYING_TIME
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - PlayingTime = " & entryAttrVal)
                ...
                Case BTSDK_AVRCP_SUBPACKET
                    ...
                    If entryAttrLen + currByteIdx <= evtData.Length Then
                        ...
                        Select Case entryAttrID
                            ...
                            Case Else
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseAttribs - Other = " & entryAttrID & " " & entryAttrVal)
                                'dont care.
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseGetFolderItemsResponse(ByVal hdl As UInt32, ByVal ptrEvtData As IntPtr)
        ...
        'ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseGetFolderItems - Len = " & strucSize)
                    ...
                    If entryItemLen + currByteIdx <= evtData.Length Then
                        ...
                        Select Case entryItemType
                            Case BTSDK_AVRCP_ITEMTYPE_MEDIAPLAYER_ITEM
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func parseBrowsableItemStru - Type = BTSDK_AVRCP_ITEMTYPE_MEDIAPLAYER_ITEM")
                                'parse BtSdkMediaPlayerItemStru at currByteIdx


                            Case BTSDK_AVRCP_ITEMTYPE_FOLDER_ITEM
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func parseBrowsableItemStru - Type = BTSDK_AVRCP_ITEMTYPE_FOLDER_ITEM")
                                ...
                                ToLog("FolderUID = " & folder_UID & "  IsPlayable = " & folder_IsPlayable & "  FolderType = " & folder_Type & "  Name = " & folder_Name)


                            Case BTSDK_AVRCP_ITEMTYPE_MEDIAELEMENT_ITEM
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func parseBrowsableItemStru - Type = BTSDK_AVRCP_ITEMTYPE_MEDIAELEMENT_ITEM")
                                ...
                                ToLog("ElementUID = " & elementItem_UID & "  IsVideo = " & elementItem_IsVideo & "  Name = " & elementItem_Name)


                            Case Else
                                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func parseBrowsableItemStru - Type = Unknown = " & entryItemType)
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseFolderItemStru(ByRef struByteArray() As Byte, ByVal struStartIdx As Integer, ByRef retUID As UInt64, ByRef retFolderType As Byte, ByRef retFolderIsPlayable As Boolean, ByRef retFolderName As String)
        ...
        ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseFolderItemStru")
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseMediaElementItemStru(ByRef struByteArray() As Byte, ByVal struStartIdx As Integer, ByRef retUID As UInt64, ByRef retMediaIsVideo As Boolean, ByRef retElementItemName As String)
        ...
        ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func ParseMediaElementItemStru")
    ...
    Private Sub BlueSoleil_AVRCP_Callback_CTResponse_ParseGeneralRejectRspStru(ByVal ptrEvtData As IntPtr, ByRef retCmdType As UInt32, ByRef retErrorCode As Byte, ByRef retErrorDesc As String)
        ...
        'ToLog("BlueSoleil_AVRCP_Callback_CTResponse_ParseGeneralRejectRspStru Len = " & strucSize)
        ...
        ToLog("Rejected CmdType = " & cmdType & "    ErrorCode = " & errorCode)
        ...
        ToLog("Rejected CmdDesc = " & retErrorDesc)
    ...
    Private Function BlueSoleil_AVRCP_Callback_CTResponse_Func(ByVal hdl As UInteger, ByVal avrcpEvent As UInt16, ByVal evtData As IntPtr) As Byte
        ...
        'ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func  Event = " & avrcpEvent)
        ...
        Select Case avrcpEvent
            ...
            Case BTSDK_APP_EV_AVRCP_GET_CAPABILITIES_RSP
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - Response To GetCapabilities")
            ...
            Case BTSDK_APP_EV_AVRCP_SET_ABSOLUTE_VOLUME_RSP
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - Response To SetAbsoluteVolume")
            ...
            Case BTSDK_APP_EV_AVRCP_PLAYBACK_STATUS_CHANGED_NOTIF
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - StatusChanged")
            ...
            Case BTSDK_APP_EV_AVRCP_GET_CURRENTPLAYER_SETTING_VALUE_RSP
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - Response To GetPlayerSetting")
            ...
            Case BTSDK_APP_EV_AVRCP_SET_CURRENTPLAYER_SETTING_VALUE_RSP
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - Response To SetPlayerSetting")
                '  BlueSoleil_AVRCP_Callback_CTResponse_ParseGetPlayerSetting(hdl, evtData)



            Case BTSDK_APP_EV_AVRCP_VOLUME_CHANGED_NOTIF
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - VolumeChanged")


            Case BTSDK_APP_EV_AVRCP_BATT_STATUS_CHANGED_NOTIF
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - BatteryChanged")
                'add battery change status here (pm)
            ...
            Case BTSDK_APP_EV_AVRCP_PLAYBACK_POS_CHANGED_NOTIF
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - PosChanged")



            Case BTSDK_AVRCP_EVENT_TRACK_REACHED_START
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - TrackReachedStart")

            Case BTSDK_AVRCP_EVENT_TRACK_REACHED_END
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - TrackReachedEnd")


            Case BTSDK_APP_EV_AVRCP_TRACK_CHANGED_NOTIF
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - TrackChanged")
            ...
            Case BTSDK_APP_EV_AVRCP_NOW_PLAYING_CONTENT_CHANGED_NOTIF
                ...
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - NowPlayingContentChanged")



            Case BTSDK_APP_EV_AVRCP_GET_FOLDER_ITEMS_RSP
                'response to request for folder items.
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - Response to GetFolderItems")


            Case BTSDK_APP_EV_AVRCP_GENERAL_REJECT_RSP
                ToLog("BlueSoleil_AVRCP_Callback_CTResponse_Func - BTSDK_APP_EV_AVRCP_GENERAL_REJECT_RSP")
    ...
    Private Function BlueSoleil_AVRCP_Callback_TGCommand_Func(ByVal dvcHandle As UInt32, ByVal tl As Byte, ByVal cmd_type As UInt16, ByVal param As IntPtr) As Byte
        ...
        ToLog("BlueSoleil_AVRCP_Callback_TGCommand_Func")


        Select Case cmd_type
            'Case BTSDK_APP_EV_AVRCP_GET_PLAY_STATUS_IND

            '    ToLog("BlueSoleil_AVRCP_Callback_TGCommand_Func BTSDK_APP_EV_AVRCP_GET_PLAY_STATUS_IND")
