...
Module modBlueSoleil_OPP
    ...
    Private Sub BlueSoleil_OPP_Callback_Status(ByVal first As Byte, ByVal last As Byte, ByVal ptrFileNameBytes As IntPtr, ByVal theFileSize As UInt32, ByVal curSize As UInt32)
        ...
        ToLog("OPP Callback.  first = " & first & "   last = " & last & "   filesize = " & theFileSize & "    cursize = " & curSize)
        ...
        If last = 0 Then
            ...
            If first <> 0 Then
                ...
                ToLog("Start OPP xfer.  0 of " & theFileSize & " bytes.")

            Else
                BlueSoleil_OPP_Callback_Status_CurrSize = BlueSoleil_OPP_Callback_Status_CurrSize + curSize
                ToLog("Continue OPP xfer.  " & BlueSoleil_OPP_Callback_Status_CurrSize & " of " & theFileSize & " bytes.")
            End If
        ...
        Else
            ...
            'add final bytes.
            BlueSoleil_OPP_Callback_Status_CurrSize = BlueSoleil_OPP_Callback_Status_CurrSize + curSize
            ToLog("Finish OPP xfer.  " & BlueSoleil_OPP_Callback_Status_CurrSize & " of " & BlueSoleil_OPP_Callback_Status_TotalSize & " bytes.")
