...
namespace OpenNETCF.Security.Cryptography
{
	public class MACTripleDES : KeyedHashAlgorithm
	{
		public MACTripleDES()
		{
			...
			IntPtr ipKey = OpenNETCF.Security.Cryptography.NativeMethods.Key.GenKey(prov, Calg.TRIP_DES, GenKeyParam.EXPORTABLE);
			key = OpenNETCF.Security.Cryptography.NativeMethods.Key.ExportSessionKey(prov, ipKey, 24, true);
			//reversed above
