...
Public Class FormFolderEx
    ...
    Private Sub RunWorkerCompleted(ByVal sender As System.Object, ByVal e As RunWorkerCompletedEventArgs)
        ...
        Try
            ...
            count = CInt(e.Result)
            If (e.Cancelled) Then
                Me.StatusBar1.Text = ("Listing was cancelled after " & count & " items.")
            Else
                Me.StatusBar1.Text = ("Listing contained " & count & " items.")
            End If
    ...
    Private Sub connectButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles connectButton.Click
        ...
        Cursor.Current = Cursors.WaitCursor
        Me.m_conn = New GuiObexSessionConnection(pf, True, Me.StatusBar1)
        Try
    ...
    Private Sub disconnectButton_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles disconnectButton.Click, MenuItem7.Click
        If Not CheckConnected() Then Exit Sub
        Me.m_conn.Close()
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        Dim vw As View = DirectCast(Me.ComboBox1.SelectedValue, View)
        ListView1.View = vw
    End Sub
    ...
    Private Sub Form1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ' view hacking
        Dim viewValues() As View = {View.List, View.SmallIcon, View.Details, View.LargeIcon}
        Me.ComboBox1.DataSource = viewValues '[Enum].GetValues(View)
        InitViewStyleUi()
        ' Images
